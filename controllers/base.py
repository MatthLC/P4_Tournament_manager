...
from controllers.menu_tournament_in_progress import MenuTournamentInProgressController
from controllers.menu_tournament_in_progress import EXECUTE_TOURNAMENT_IN_PROGRESS_MENU
